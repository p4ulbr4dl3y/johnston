...
class ToolContext:
    ...
    def __init__(self, app: Any = None, is_subagent: bool = False, cwd: str = None):
        ...
        self.is_subagent = bool(is_subagent) or _get_bool(raw_target, "is_subagent") or _get_bool(app, "is_subagent")
        self.is_headless = _get_bool(raw_target, "is_headless") or _get_bool(app, "is_headless")
