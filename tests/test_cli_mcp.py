...
from johnston_core.infrastructure.mcp import config as mcp_config
...
from johnston_core.interfaces.cli.commands.mcp_cmd import (
    add_mcp,
    disable_mcp,
    enable_mcp,
    list_mcp,
...
class TestCLIMCP(unittest.TestCase):
    ...
    def test_main_subcommand_mcp(self):
        with patch("johnston_core.interfaces.cli.commands.mcp_cmd.run_mcp", return_value=0) as mock_run:
