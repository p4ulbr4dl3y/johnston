...
from johnston_tui.presentation.screens.ask_user import WRITE_IN_LABEL, AskUserWizardScreen
...
class TestAskUserExtra(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_force_modal_focus_query_exceptions(self):
        from johnston_tui.presentation.screens.ask_user import WRITE_IN_INPUT
