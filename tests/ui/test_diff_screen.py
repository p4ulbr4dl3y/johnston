...
from johnston.tui.presentation.commands import DiffCommand
from johnston.tui.presentation.screens.diff import DiffFooter, DiffHeader, DiffScreen, disambiguate_file_paths
...
class TestDiffCommand(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_diff_command_no_changes(self):
        ...
        with patch("johnston.core.application.session.actions.get_session_diff", new_callable=AsyncMock) as mock_get_diff:
