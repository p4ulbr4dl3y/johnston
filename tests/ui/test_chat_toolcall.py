...
class TestToolCallWidgetHelpers(unittest.TestCase):
    ...
    def test_format_compact_dict(self):
        from johnston.tui.presentation.tool_display import format_compact_dict
...
class TestToolCallWidgetRendering(unittest.TestCase):
    ...
    def test_on_click_invoke_subagent_pushes_screen(self):
        ...
        with (
            patch("johnston.tui.presentation.screens.subagent_screen.SubagentViewScreen") as screen_cls,
    ...
    def test_on_click_invoke_subagent_error_with_session_is_clickable(self):
        ...
        with (
            ...
            app_prop.return_value = app
            widget.on_click(event)
        screen_cls.assert_called_once_with("abc")
    ...
    def test_on_click_shell_toggles_expansion(self):
        ...
        with (
            patch("johnston.tui.presentation.screens.tasks.ShellTasksScreen") as shell_screen_cls,
            patch.object(ToolCallWidget, "app", new_callable=PropertyMock) as app_prop,
        ):
            app = MagicMock()
    ...
    def test_on_click_message_subagent_with_id_opens_subagent_view_screen(self):
        ...
        mock_store.find_session_by_title_or_id.return_value = MagicMock(status="running")
        with (
            patch("johnston.tui.presentation.screens.subagent_screen.SubagentViewScreen") as subagent_view_screen_cls,
            patch.object(ToolCallWidget, "app", new_callable=PropertyMock) as app_prop,
        ):
            app = MagicMock()
            app.sm = mock_store
...
class TestToolCallWidgetRenderContent(unittest.TestCase):
    ...
    def test_truncate_path_small_max_len_no_slashes(self):
        from johnston.tui.presentation.tool_display import truncate_path
