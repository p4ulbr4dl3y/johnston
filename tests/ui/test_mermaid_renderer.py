...
from johnston_tui.presentation.widgets.chat_markdown import CustomMarkdownFence, prewarm_fences_from_markdown
from johnston_tui.utils.mermaid_renderer import (
    _store_cache,
    clean_mermaid_code,
    clear_mermaid_cache,
...
'''
    ...
    def test_fix_mojibake(self):
        from johnston_tui.utils.mermaid_renderer import _fix_mojibake
    ...
    def test_render_mermaid_missing_binary(self):
        with patch("johnston_tui.utils.mermaid_renderer._get_mermaid_binary", return_value=None):
    ...
    def test_store_cache_eviction(self):
        with patch("johnston_tui.utils.mermaid_renderer._CACHE_MAX_SIZE", 3):
            _store_cache("k1", "v1")
            _store_cache("k2", "v2")
            _store_cache("k3", "v3")
            _store_cache("k4", "v4")
...
class TestCustomMarkdownFenceMermaid:
    ...
    async def test_async_render_mermaid_on_cache_miss(self):
        ...
        with patch("johnston_tui.utils.mermaid_renderer.render_mermaid_to_ascii", return_value="┌───┐\n│ X │\n└───┘"):
