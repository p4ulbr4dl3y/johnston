...
class TestToolDisplay(unittest.TestCase):
    ...
    def test_build_toolcall_header_without_diff_stats(self):
        ...
        self.assertNotIn("+2", hdr)
        self.assertNotIn("-1", hdr)
