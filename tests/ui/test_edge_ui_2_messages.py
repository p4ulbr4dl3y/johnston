...
from johnston.tui.presentation.widgets.chat_messages import BotMessage, EventDivider, UserMessage
...
class TestUserMessage(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_attachment_text_and_unselectable_footnote(self):
        ...
        from johnston.tui.presentation.widgets.chat_messages import UserMessageAttachment
