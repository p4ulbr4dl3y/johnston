...
class TestMarkdownHelpers(unittest.TestCase):
    ...
    def test_markdown_blocks_table_open_is_patched(self):
        ...
        from johnston_tui.presentation.widgets.chat_markdown import _apply_chat_markdown_patches
    ...
    def test_handle_markdown_task_done(self):
        from johnston_tui.presentation.widgets.chat_markdown import _handle_markdown_task_done
    ...
    def test_markdown_block_inline_code_style(self):
        from johnston_tui.presentation.widgets.chat_markdown import _new_markdown_block_get_style
...
class TestFenceHighlightCache(unittest.TestCase):
    ...
    def _clear_cache(self):
        from johnston_tui.presentation.widgets import chat_markdown
    ...
    def test_resolve_highlight_lexer_fallbacks(self):
        from johnston_tui.presentation.widgets.chat_markdown import resolve_highlight_lexer
    ...
    def test_prewarm_skips_empty_and_unclosed_blocks(self):
        from johnston_tui.presentation.widgets.chat_markdown import _highlight_cache, prewarm_fences_from_markdown
    ...
    def test_prewarm_matches_indented_fence_like_clean_markdown(self):
        from johnston_tui.presentation.widgets.chat_markdown import prewarm_fences_from_markdown
    ...
    def test_diagram_scroll_box_ignores_wheel(self):
        ...
        from johnston_tui.presentation.widgets.chat_markdown import DiagramScrollBox
    ...
    def test_thin_scrollbar_render(self):
        ...
        from johnston_tui.presentation.widgets.chat_markdown import DiagramScrollBox, ThinScrollBarRender
