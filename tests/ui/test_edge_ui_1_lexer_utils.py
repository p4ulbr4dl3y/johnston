"""Edge-case tests for utils/diff_builder.py (bug-hunting round)."""
import unittest
from unittest.mock import patch

from johnston.tui.utils.diff_builder import generate_chunk_unified_diff
...
class TestLexBlockToLineTexts(unittest.TestCase):
    ...
    def test_lexer_exception_falls_back_to_plain(self):
        with patch(
            "johnston.tui.utils.lexer.pygments.lex", side_effect=RuntimeError("boom")
        ):
