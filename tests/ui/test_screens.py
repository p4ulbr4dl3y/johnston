...
class TestResumeScreen(unittest.TestCase):
    def test_init_with_sessions(self):
        ...
        self.assertIn("5 turns", s.raw_options[0])
...
class TestTaskScreens(unittest.TestCase):
    ...
    def test_tasks_screen_search_and_nav(self):
        ...
        from johnston.tui.presentation.screens.constants import MODAL_HINT_ID
    ...
    def test_tasks_screen_sort_newest_first(self):
        from johnston.tui.presentation.screens.tasks import _filter_and_sort_tasks
