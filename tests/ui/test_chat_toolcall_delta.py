...
from johnston_core.infrastructure.tasks.output import process_carriage_returns
from johnston_tui.chat_toolcall import ToolCallWidget, _bash_safe_boundary, format_truncation_for_ui
...
class TestIncrementalFlushMatchesLegacy(unittest.TestCase):
    ...
    def test_per_flush_work_is_bounded_by_delta(self):
        ...
        with patch("johnston_tui.chat_toolcall.format_truncation_for_ui", side_effect=spy):
            for chunk in stream:
                widget.append_shell_output(chunk)
