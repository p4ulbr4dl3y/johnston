...
def test_chat_view_page_size_respects_settings(monkeypatch):
    ...
    monkeypatch.setattr("johnston.tui.presentation.widgets.chat_container.get_settings", lambda: settings)
...
def test_bot_message_stream_flush_interval_respects_settings(monkeypatch):
    ...
    monkeypatch.setattr("johnston.tui.presentation.widgets.chat_messages.get_settings", lambda: settings)
    captured = {}
