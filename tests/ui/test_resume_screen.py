...
from johnston.tui.presentation.screens.resume import ResumeScreen, _order_sessions_hierarchically
...
class TestResumeScreenPilot(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_resume_screen_rename_pilot(self):
        ...
        async with app.run_test() as pilot:
            ...
            await pilot.pause()
            from johnston.tui.presentation.screens.rename_session import RenameSessionScreen
