...
from johnston_tui.presentation.widgets.chat_diff import DiffRenderable, format_edit_diff
...
class TestFormatEditDiff(unittest.TestCase):
    ...
    def test_diff_renderable_hanging_indent_wrapping(self):
        ...
        from johnston_tui.presentation.widgets.chat_diff import DiffLine
    ...
    def test_get_diff_colors_dark_and_light(self):
        ...
        from johnston_tui.presentation.widgets.chat_diff import get_diff_colors, get_diff_word_colors
...
def test_format_edit_diff_lex_cache_reuses_identical_inputs(monkeypatch):
    import johnston_tui.presentation.widgets.chat_diff as cd
