...
from johnston_tui.presentation.widgets.footer_layout import format_display_path
from johnston_tui.presentation.widgets.subagent_footer import SubagentHeader, SubagentStatusFooter
...
_mcp_mgr_patch = "johnston_core.infrastructure.mcp.get_mcp_manager"
...
class TestStatusFooterCoverage(unittest.TestCase):
    ...
    def test_format_display_path_worktree_exact_and_long(self):
        ...
        self.assertEqual(format_display_path(subpath), "subagent-16ab6b (wt)")
        ...
        self.assertTrue(res.endswith(" (wt)"))
    ...
    def test_status_footer_no_pm_and_bad_app_size(self):
        ...
        with patch("johnston_tui.status_footer.catalog.get_model_display_name", return_value=""):
...
class TestSubagentStatusFooterCoverage(unittest.TestCase):
    ...
    def test_render_footer_provider_active_and_pricing(self):
        ...
        with patch("johnston_tui.status_footer.catalog.get_model_display_name", return_value=""), patch(
            "johnston_tui.status_footer.catalog.estimate_cost_from_totals", return_value=0.0,
    ...
    def test_render_footer_compact_mode(self):
        ...
        footer._harness_app = app
        footer.session = session
        with patch("johnston_tui.status_footer.catalog.get_model_display_name", return_value="gpt-4o"), patch.object(
