...
class TestCreateTool(_Base):
    ...
    async def test_create_overwrite_large_file_skips_diff(self):
        ...
        with patch("core.tools.create.get_max_tool_payload_bytes", return_value=5):
    ...
    async def test_create_diff_generation_failure_still_reports_success(self):
        ...
        with patch("core.tools.create.format_file_diff", side_effect=RuntimeError("diff broke")):
    ...
    def test_format_file_diff_truncation(self):
        from core.tools.utils import format_file_diff
