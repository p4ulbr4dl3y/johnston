...
from johnston_core.tools.registry import REGISTRY, execute_tool
from johnston_core.tools.search import (
    _OUTLINE_CACHE,
    SearchTool,
    _GitignoreMatcher,
    _glob_to_regex,
...
from johnston_tui.presentation.tool_display import extract_tool_display
...
class TestSearchTool(unittest.IsolatedAsyncioTestCase):
    ...
    def test_outline_kotlin(self):
        ...
        from johnston_core.tools.search import _outline_generic_content
    ...
    def test_direct_ripgrep_with_context(self):
        ...
        from johnston_core.tools.search import _search_content_ripgrep
        if not shutil.which("rg"):
    ...
    def test_role_policies_allow_search(self):
        from johnston_core.domain.policies.role_policy import role_tool_error
        from johnston_core.role_registry import BUILTIN_ROLES
    ...
    def test_ripgrep_delimiter_during_stopping(self):
        ...
        from johnston_core.tools.search.content import _search_content_ripgrep
...
class TestLRUCache(unittest.TestCase):
    ...
    def test_cache_hit(self):
        ...
        from johnston_core.tools.search import _outline_file
...
class TestGeneratorWalk(unittest.TestCase):
    ...
    def test_early_termination(self):
        ...
        from johnston_core.tools.search import _walk_filtered
...
class TestTreeSitter(unittest.TestCase):
    ...
    def test_tree_sitter_available(self):
        ...
        from johnston_core.tools.search import TREE_SITTER_AVAILABLE
...
""")
    ...
    def test_generic_outline_no_false_positive_on_line_query(self):
        ...
        from johnston_core.tools.search.outline import _outline_generic_content
    ...
    def test_re_generic_def_no_empty_matches(self):
        ...
        from johnston_core.tools.search.outline import RE_GENERIC_DEF
    ...
    def test_search_filename_ripgrep_path_normalization(self):
        ...
        from johnston_core.tools.search.files import _search_filename_ripgrep
