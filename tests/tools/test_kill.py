...
async def test_kill_subagent_success(kill_tool, monkeypatch):
    ...
    monkeypatch.setattr("johnston_core.application.session.subagent_service.SubagentService.kill_subagent", kill_mock)
...
async def test_kill_process_fallback(kill_tool, monkeypatch):
    ...
    term_mock = AsyncMock()
    monkeypatch.setattr("johnston_core.infrastructure.platform.process.terminate_process_tree", term_mock)
