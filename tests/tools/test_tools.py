...
class TestTools(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_read_tool(self):
        ...
        with patch("core.tools.read.tool.convert_doc_to_markdown_sync", return_value="# Converted PDF Header\nPDF body text"):
    ...
    async def test_read_tool_doc_caching(self):
        from core.tools.read import convert_doc_to_markdown_sync
        ...
        with patch("core.tools.read.doc.set_cached_doc_markdown") as mock_set:
