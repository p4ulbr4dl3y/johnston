...
class TestSubagentApplyRole(unittest.TestCase):
    ...
    def test_configure_agent_unified_main_and_subagent(self):
        ...
        from johnston_core.application.session.stream import configure_agent
        from johnston_core.role_registry import RoleRegistry
...
class TestSubagentApplyProvider(unittest.TestCase):
    def test_rebind_provider_in_place(self):
        ...
        from johnston_core.roles.provider import rebind_provider
        ...
        with mock.patch("johnston_core.provider_manager.ProviderManager", return_value=fake_pm):
...
class TestSubagentRoleStrictMatch(unittest.IsolatedAsyncioTestCase):
    ...
    def test_subagent_default_prompt_directives(self):
        from johnston_core.domain.defaults.prompts import SUBAGENT_DEFAULT_SYSTEM_PROMPT
    ...
    def test_headless_prompt_directives(self):
        from johnston_core.domain.defaults.prompts import HEADLESS_DEFAULT_SYSTEM_PROMPT
