...
from johnston.core.domain.entities.session import SessionKind
from johnston.core.infrastructure.config.settings import JohnstonSettings, StorageSettings
...
from johnston.core.infrastructure.storage.session_store_cache import SessionStoreCacheMixin
from johnston.core.infrastructure.storage.session_store_locks import SessionStoreLocksMixin
from johnston.core.infrastructure.storage.session_store_paths import SessionStorePathsMixin
...
def test_cache_mixin_standalone(monkeypatch):
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        monkeypatch.setattr("johnston.core.infrastructure.storage.session_store.get_settings", lambda: custom_settings)
