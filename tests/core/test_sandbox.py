...
def test_generate_seatbelt_profile():
    ...
    assert "providers.json" in profile
    assert "mcp.json" in profile
...
def test_is_path_readable_in_sandbox():
    ...
    assert is_path_readable_in_sandbox(os.path.join(home, ".johnston", "providers.json")) is False
    assert is_path_readable_in_sandbox(os.path.join(home, ".johnston", "mcp.json")) is False
