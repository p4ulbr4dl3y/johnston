...
async def test_read_tool_mcp_resource_integration():
    ...
    with patch("johnston_core.infrastructure.mcp.get_mcp_manager", return_value=mock_mgr):
...
async def test_mcp_prompt_command_suggestions_and_dispatch():
    ...
    from johnston_tui.app.command_provider import _build_command_suggestions
