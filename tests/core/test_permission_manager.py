...
from core.application.permission.permission_manager import LOGS_DIR, SECRETS_FILE, PermissionManager
...
class TestPermissionManager(unittest.TestCase):
    def setUp(self):
        ...
        self.config_patcher = patch("core.application.permission.permission_manager.CONFIG_FILE", "/nonexistent_test_config.json")
    ...
    def test_mcp_tools_mode_baseline(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            with patch("core.application.permission.permission_manager.CONFIG_FILE", cfg_file):
