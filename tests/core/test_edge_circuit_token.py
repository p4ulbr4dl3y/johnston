...
from johnston_core.infrastructure.runtime.circuit_breaker import CircuitBreaker
...
class TestCircuitBreakerEdgeCases(unittest.TestCase):
    def setUp(self):
        ...
        self.time_patcher = mock.patch("johnston_core.infrastructure.runtime.circuit_breaker.time.time", self.clock.time)
