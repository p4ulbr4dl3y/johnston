...
from johnston_core.domain.defaults.themes import list_themes
from johnston_core.domain.entities.theme import Theme, is_ansi_theme
from johnston_tui.app.theme_manager import ThemeManager
...
def test_theme_persistence(tmp_path, monkeypatch):
    ...
    monkeypatch.setattr("johnston_core.infrastructure.platform.paths.CONFIG_FILE", cfg_file)

    from johnston_core.infrastructure.config.config_helpers import load_theme_config, save_theme_config
...
def test_themes_loader_module():
    import johnston_core.domain.defaults.themes as themes_mod
    from johnston_core.domain.defaults.themes import (
        DEFAULT_THEME_NAME,
        ZINC_DARK,
        get_theme,
        list_themes,
...
def test_ui_theme_manager_adapted_theme(monkeypatch):
    from johnston_tui.app.theme_manager import ThemeManager as UIThemeManager
    ...
    monkeypatch.setattr(
        "johnston_core.infrastructure.platform.terminal_theme.query_terminal_palette",
...
def test_dynamic_diff_and_tool_colors():
    from johnston_tui.presentation.tool_mixins import ParsingMixin
    from johnston_tui.presentation.widgets.chat_diff import get_diff_colors
    from johnston_tui.presentation.widgets.footer_layout import get_status_separators
...
def test_prewarm_terminal_palette_requires_running_loop():
    ...
    from johnston_tui.app.theme_manager import prewarm_terminal_palette
...
def test_prewarm_terminal_palette_fire_and_forget(monkeypatch):
    ...
    from johnston_core.infrastructure.platform import terminal_theme
    from johnston_tui.app.theme_manager import prewarm_terminal_palette
