...
from johnston.core.infrastructure.converter import (
    convert_bytes,
    convert_file,
    is_convertible,
)
from johnston.core.infrastructure.converter.docx import docx_to_markdown
from johnston.core.infrastructure.converter.epub import epub_to_markdown
from johnston.core.infrastructure.converter.html import html_to_markdown
from johnston.core.infrastructure.converter.ipynb import ipynb_to_markdown
from johnston.core.infrastructure.converter.pdf import pdf_to_markdown
from johnston.core.infrastructure.converter.pptx import pptx_to_markdown
from johnston.core.infrastructure.converter.xlsx import xlsx_to_markdown
...
<w:tbl><w:tr><w:tc><w:p><w:r><w:t>NESTED</w:t></w:r></w:p></w:tc></w:tr></w:tbl>
    ...
    def test_fenced_code_block_dynamic_length(self):
        from johnston.core.infrastructure.converter.utils import fenced_code_block
...
class TestDocConverterSecondaryAuditFixes(unittest.TestCase):
    ...
    def test_clean_url_inverted_parens(self):
        from johnston.core.infrastructure.converter.utils import clean_url
    ...
    def test_collapse_blank_lines_crlf(self):
        from johnston.core.infrastructure.converter.utils import collapse_blank_lines
