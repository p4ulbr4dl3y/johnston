...
class TestErrorStreamEdgeCases(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_circuit_breaker_open_raises_error(self):
        ...
        with unittest.mock.patch("johnston_core.infrastructure.runtime.circuit_breaker.circuit_breaker", fake_cb):
            events = []
    ...
    def test_calculate_retry_delay_with_retry_after(self):
        from johnston_core.base_provider.errors import calculate_retry_delay
