...
from johnston.core.infrastructure.llm.base import format_api_error
...
class TestErrorHandlingMixin(unittest.TestCase):
    ...
    def test_sanitize_user_image_url_replaced_with_note(self):
        ...
        self.assertIn('<system_note kind="images_omitted"', res[0]["content"])
        self.assertIn('reason="vision_unsupported"', res[0]["content"])
