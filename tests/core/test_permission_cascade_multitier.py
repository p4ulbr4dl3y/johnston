...
from johnston.core.domain.policies.permission_policy import ExecutionMode, PermissionAction
...
class TestPermissionCascadeMultitier(unittest.TestCase):
    def setUp(self):
        ...
        self.patcher = patch("johnston.core.application.permission.permission_manager.CONFIG_FILE", self.global_config_file)
        self.patcher.start()
    ...
    def test_auto_gitignore_no_git_does_nothing(self):
        ...
        with patch("johnston.core.application.permission.permission_manager.is_git_repository", return_value=False):
    ...
    def test_same_mtime_same_size_rewrite_cascade(self):
        ...
        to DENY."""
        from johnston.core.infrastructure.platform.platform_utils import invalidate_json_read_cache
