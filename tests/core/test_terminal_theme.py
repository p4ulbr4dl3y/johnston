...
from johnston_core.infrastructure.platform.terminal_theme import (
    _cbrt,
...
def test_cbrt_fallback(monkeypatch):
    import johnston_core.infrastructure.platform.terminal_theme as tt
...
def test_query_terminal_palette_windows_mock(monkeypatch):
    ...
    monkeypatch.setattr(
        "johnston_core.infrastructure.platform.terminal_theme._query_windows_palette",
...
def test_lerp_oklab():
    from johnston_core.infrastructure.platform.terminal_theme import lerp_oklab
...
def test_detect_os_theme_dark(monkeypatch):
    from johnston_core.infrastructure.platform.terminal_theme import detect_os_theme_dark
...
def test_compute_adaptive_palette_dark_and_light():
    from johnston_core.infrastructure.platform.terminal_theme import compute_adaptive_palette
