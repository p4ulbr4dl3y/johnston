...
from johnston.core.domain.policies.policy_shell import check_read_only_command_mutations
from johnston.core.infrastructure.platform.process import spawn_shell_process, spawn_windows_process
...
async def test_spawn_shell_process_sandboxed():
    with (
        patch(
            "johnston.core.infrastructure.platform.sandbox.build_sandboxed_command",
...
async def test_spawn_shell_process_windows_default():
    with (
        patch(
            "johnston.core.infrastructure.platform.process.spawn_windows_process",
...
async def test_terminate_process_tree_windows():
    ...
    with (
        patch("johnston.core.infrastructure.platform.process.is_windows", return_value=True),
...
def test_terminate_process_tree_sync_windows():
    from johnston.core.infrastructure.platform.process import terminate_process_tree_sync
