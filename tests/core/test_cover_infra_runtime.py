...
import johnston.core.infrastructure.platform.platform_utils as pu
import johnston.core.infrastructure.runtime.fs_signature as fs
...
def test_copy_to_os_clipboard_windows_clip():
    with (
        ...
        patch("johnston.core.infrastructure.platform.platform_utils.shutil.which"),
        patch("johnston.core.infrastructure.platform.platform_utils.subprocess.Popen") as popen,
    ):
        p = MagicMock()
...
def test_copy_to_os_clipboard_pbcopy():
    with (
        ...
        patch("johnston.core.infrastructure.platform.platform_utils.shutil.which", side_effect=lambda n: n == "pbcopy"),
        patch("johnston.core.infrastructure.platform.platform_utils.subprocess.Popen") as popen,
    ):
        p = MagicMock()
        popen.return_value = p
...
def test_copy_to_os_clipboard_wl_copy():
    with (
        patch("johnston.core.infrastructure.platform.platform_utils.is_windows", return_value=False),
        patch("johnston.core.infrastructure.platform.platform_utils.shutil.which", side_effect=lambda n: n == "wl-copy"),
        patch("johnston.core.infrastructure.platform.platform_utils.subprocess.Popen") as popen,
    ):
        p = MagicMock()
        popen.return_value = p
...
def test_copy_to_os_clipboard_spawn_error_swallowed():
    with (
        patch("johnston.core.infrastructure.platform.platform_utils.is_windows", return_value=False),
        patch("johnston.core.infrastructure.platform.platform_utils.shutil.which", side_effect=lambda n: n == "pbcopy"),
        patch("johnston.core.infrastructure.platform.platform_utils.subprocess.Popen", side_effect=OSError("no pbcopy")),
    ):
...
async def test_copy_to_os_clipboard_async():
    with patch("johnston.core.infrastructure.platform.platform_utils.copy_to_os_clipboard") as m:
