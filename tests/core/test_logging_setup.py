...
from johnston_core.infrastructure.platform.logging_setup import (
...
def test_install_excepthook_registers_and_is_idempotent():
    import johnston_core.infrastructure.platform.logging_setup as ls
...
def test_uncaught_exception_hook_forwards_keyboard_interrupt(monkeypatch):
    captured = []
    monkeypatch.setattr(
        "johnston_core.infrastructure.platform.logging_setup._ORIGINAL_EXCEPTHOOK",
