...
from johnston_core.application.skills.manager import SkillManager, get_skill_manager
...
def _reset_skill_managers() -> None:
    ...
    import johnston_core.application.skills.manager as _skm
...
class TestSkillManager(unittest.IsolatedAsyncioTestCase):
    ...
    def test_skill_manager_construction_has_no_side_effects(self):
        with patch("johnston_core.application.skills.manager.os.makedirs") as mock_makedirs:
    ...
    def test_get_skill_manager_bundled_skills_no_disk_copy(self):
        _reset_skill_managers()
        with patch(
            "johnston_core.application.skills.manager.GLOBAL_SKILLS_DIR",
