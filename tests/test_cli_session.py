...
from johnston_core.interfaces.cli.commands.session_cmd import (
    export_session,
    list_sessions,
    prune_sessions,
    rm_session,
...
class TestCLISession(unittest.TestCase):
    ...
    def test_run_session_dispatcher(self):
        ...
        with patch("johnston_core.interfaces.cli.commands.session_cmd.list_sessions", return_value=0) as m_list:
        ...
        with patch("johnston_core.interfaces.cli.commands.session_cmd.rm_session", return_value=0) as m_rm:
        ...
        with patch("johnston_core.interfaces.cli.commands.session_cmd.prune_sessions", return_value=0) as m_prune:
        ...
        with patch("johnston_core.interfaces.cli.commands.session_cmd.export_session", return_value=0) as m_exp:
    ...
    def test_cli_session_via_main(self):
        with patch("johnston_core.interfaces.cli.commands.session_cmd.run_session", return_value=0) as m_run:
