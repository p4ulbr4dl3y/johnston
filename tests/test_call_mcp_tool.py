...
class TestCallMCPTool(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_successful_call(self):
        ...
        mock_mgr.call_tool.assert_called_once_with(tool_name="read_file", arguments={"path": "/tmp"}, target_server="fs")
    ...
    async def test_arguments_default_empty(self):
        ...
        mock_mgr.call_tool.assert_called_once_with(tool_name="t", arguments={}, target_server="srv")
