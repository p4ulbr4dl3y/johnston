...
from core.infrastructure.tasks.output import is_spinner_line, process_carriage_returns, process_carriage_returns_lines
...
def _format_trunc(text: str, *, strip_edges: bool = True) -> str:
    ...
    mod = sys.modules.get("widgets.chat_toolcall")
