...
async def check_and_confirm_permission(
    ...
    from johnston.core.domain.policies.permission_policy import PermissionAction
    from johnston.core.tools.base import confirm_permission, resolve_subagent_identity
...
async def execute_tool(name: str, args: dict | None, app: Any = None, context: Any = None) -> ToolResult:
    ...
    from johnston.core.tools.base import check_mcp_role_policy
    ...
    try:
        from johnston.core.infrastructure.config.settings import get_settings
        from johnston.core.tools.base import execute_mcp_tool, truncate_output
...
class DefaultToolRegistry:
    ...
    def process_image_file(self, path: str) -> Any:
        from johnston.core.tools.read import process_image_file_sync
