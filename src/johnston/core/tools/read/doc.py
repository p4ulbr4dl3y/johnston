...
from johnston.core.tools.read.cache import get_cached_doc_markdown, set_cached_doc_markdown
...
def convert_doc_to_markdown_sync(
    ...
    **_kwargs: Any,
    ...
    try:
        from johnston.core.infrastructure.converter import convert_file
