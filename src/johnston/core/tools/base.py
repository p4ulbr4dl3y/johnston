...
from johnston.core.infrastructure.platform.paths import LOGS_DIR
from johnston.core.infrastructure.platform.platform_utils import atomic_write_text
...
def resolve_writable_path(ctx: Any, path_arg: Any) -> tuple[str, "ToolResult | None"]:
    ...
    from johnston.core.tools.utils import resolve_writable_path as _resolve_writable_path
...
def _write_output_log(
    ...
    *,
    ...
    from johnston.core.infrastructure.tasks.output import make_log_path
...
def truncate_output(
    ...
    if from_end:
        ...
        from johnston.core.tools.utils import truncate_leading
