...
from johnston.core.domain.defaults.config import DEFAULT_AGENT_MD_MAX_CHARS
...
def get_project_instructions_snippet(cwd: str = None) -> str:
    ...
    from johnston.core.infrastructure.runtime.prompt_markdown import format_rules_markdown
