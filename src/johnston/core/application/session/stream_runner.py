...
from johnston.core.application.session.stream_agent import merge_subagent_metrics, sync_session_metrics
from johnston.core.application.session.stream_steps import record_session_step
            ...
            if not is_suppressed and not session_switched:
                if notification_template:
                    try:
                        ...
                        if truncate_result:
                            from johnston.core.infrastructure.tasks.output import truncate_subagent_result
