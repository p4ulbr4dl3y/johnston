...
from johnston.core.infrastructure.runtime.git_utils import run_git_async
from johnston.core.infrastructure.runtime.subagent_tracker import record_subagent_session
...
class SubagentService:
    ...
    async def spawn_subagent(
        ...
        *,
        ...
        from johnston.core.application.session.stream import run_subagent_stream_bg
    ...
    async def send_message(
        ...
        from johnston.core.application.session.stream import send_subagent_followup
