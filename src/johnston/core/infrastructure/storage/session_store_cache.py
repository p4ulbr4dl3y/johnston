...
from johnston.core.infrastructure.runtime.fs_signature import compute_dir_signature_hash
from johnston.core.infrastructure.storage.session_index_db import SessionIndexDb
from johnston.core.infrastructure.storage.session_serialization import from_file as _session_from_file
...
class SessionStoreCacheMixin:
    ...
    def DISK_CACHE_TTL(self) -> float:
        ...
        mod = sys.modules.get("johnston.core.infrastructure.storage.session_store")
