...
from johnston.core.domain.defaults.git_excludes import DEFAULT_EXCLUDES
from johnston.core.domain.ports.checkpoint import set_default_checkpoint_manager
from johnston.core.infrastructure.platform.paths import SHADOW_REPOS_DIR
from johnston.core.infrastructure.runtime.git_utils import is_git_repository, run_git
from johnston.core.infrastructure.storage.git_checkpoint_diff import GitCheckpointDiffMixin
from johnston.core.infrastructure.storage.git_checkpoint_ops import GitCheckpointOpsMixin
from johnston.core.infrastructure.storage.git_checkpoint_restore import GitCheckpointRestoreMixin
from johnston.core.infrastructure.storage.git_diff_parser import parse_numstat, split_git_diff  # noqa: F401
from johnston.core.infrastructure.storage.git_shadow_env import (
    base_shadow_env,
