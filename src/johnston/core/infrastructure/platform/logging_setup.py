...
from johnston.core.infrastructure.platform.paths import LOGS_DIR, TEMP_IMAGES_DIR
from johnston.core.infrastructure.platform.platform_utils import IMAGE_EXTENSIONS, cleanup_dir_by_age
