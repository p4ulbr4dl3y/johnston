...
def format_duration(seconds: float | int | None) -> str:
    ...
    from johnston.core.infrastructure.tasks.manage import format_duration as _canonical
...
def option_list_row_width(opt_list: Any, default: int) -> int:
    ...
    try:
        from johnston.tui.utils.responsive import MODAL_CONTENT_GUTTER, MODAL_WIDTH_RATIO, resolve_screen_width
