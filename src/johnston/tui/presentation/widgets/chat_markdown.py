        ...
        if closed and code_lines:
            try:
                ...
                if lang and lang.strip().lower() in ("mermaid", "mmd"):
                    from johnston.tui.utils.mermaid_renderer import prewarm_mermaid
...
class CustomMarkdownFence(MarkdownFence):
    ...
    def __init__(self, markdown: Markdown, token: Any, code: str) -> None:
        ...
        from johnston.tui.utils.mermaid_renderer import get_cached_mermaid, is_mermaid
    ...
    def on_mount(self) -> None:
        lang_str = self.lexer.strip() if self.lexer else "text"
        from johnston.tui.utils.mermaid_renderer import is_mermaid
    ...
    async def _async_render_mermaid(self) -> None:
        ...
        from johnston.tui.utils.mermaid_renderer import format_mermaid_content, render_mermaid_to_ascii
    ...
    async def _update_from_block(self, block: MarkdownBlock) -> None:
        if isinstance(block, CustomMarkdownFence):
            ...
            from johnston.tui.app.theme_manager import theme_manager
            from johnston.tui.utils.mermaid_renderer import format_mermaid_content, is_mermaid
    ...
    def compose(self) -> ComposeResult:
        lang_str = self.lexer.strip() if self.lexer else "text"
        from johnston.tui.utils.mermaid_renderer import format_mermaid_content, get_cached_mermaid, is_mermaid
    ...
    def toggle_diagram_view(self) -> None:
        ...
        from johnston.tui.app.theme_manager import theme_manager
        from johnston.tui.utils.mermaid_renderer import format_mermaid_content
