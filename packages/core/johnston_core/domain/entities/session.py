...
class AgentSession:
    ...
    def role_name(self) -> str:
        ...
        from johnston_core.role_registry import resolve_role_display_name
    ...
    def plan(self) -> Optional[List[Dict[str, Any]]]:
        ...
        if getattr(self, "messages", None):
            try:
                from johnston_core.application.session.rewind import restore_plan_from_messages
    ...
    def add_event(self, event: Dict[str, Any]) -> None:
        ...
        from johnston_core.infrastructure.runtime.session_coalescer import add_event

        add_event(self, event)

    def add_listener(self, cb: Any) -> None:
        from johnston_core.infrastructure.runtime.session_coalescer import add_listener

        add_listener(self, cb)

    def remove_listener(self, cb: Any) -> None:
        from johnston_core.infrastructure.runtime.session_coalescer import remove_listener
    ...
    def _history(self) -> List[Dict[str, Any]]:
        ...
        from johnston_core.infrastructure.storage.session_serialization import session_history
    ...
    def _persistent_fields(self) -> Dict[str, Any]:
        ...
        from johnston_core.infrastructure.storage.session_serialization import persistent_fields

        return persistent_fields(self)

    def to_dict(self) -> Dict[str, Any]:
        from johnston_core.infrastructure.storage.session_serialization import to_dict

        return to_dict(self)

    def to_jsonl_lines(self) -> List[Dict[str, Any]]:
        from johnston_core.infrastructure.storage.session_serialization import to_jsonl_lines

        return to_jsonl_lines(self)

    @classmethod
    def from_dict(cls, data: Dict[str, Any]) -> "AgentSession":
        from johnston_core.infrastructure.storage.session_serialization import from_dict
    ...
    def from_file(cls, fpath: str) -> Optional["AgentSession"]:
        from johnston_core.infrastructure.storage.session_serialization import from_file
...
def record_session_interruption(session: Any, divider_text: str = "Response Interrupted") -> None:
    ...
    from johnston_core.infrastructure.runtime.session_interruption import (
