...
from johnston_core.infrastructure.converter import DOC_EXTENSIONS
from johnston_core.infrastructure.platform.platform_utils import IMAGE_EXTENSIONS
from johnston_core.tools.base import BaseTool, _write_output_log, get_fuzzy_matches, resolve_path, try_int
from johnston_core.tools.cancel import run_cancellable
from johnston_core.tools.read.archive import (
    _inspect_archive,
    is_archive_file,
    read_archive_member,
    split_archive_path,
)
from johnston_core.tools.read.cache import get_max_dir_entries
from johnston_core.tools.read.directory import _inspect_directory
from johnston_core.tools.read.doc import convert_doc_to_markdown_sync
from johnston_core.tools.read.image import process_image_file_sync
from johnston_core.tools.read.text import _read_file_lines
from johnston_core.tools.utils import (
    DEFAULT_LINE_WINDOW,
...
class ReadTool(BaseTool):
    ...
    async def execute(self, args: Dict[str, Any], ctx: Any = None) -> ToolResult:
        ...
        if getattr(ctx, "sandbox_enabled", False):
            from johnston_core.infrastructure.platform.sandbox import is_path_readable_in_sandbox
