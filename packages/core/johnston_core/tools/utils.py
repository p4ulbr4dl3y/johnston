...
from johnston_core.tools.base import try_int
...
def resolve_writable_path(ctx: Any, path_arg: Any) -> tuple[str, ToolResult | None]:
    ...
    if getattr(ctx, "sandbox_enabled", False):
        from johnston_core.infrastructure.platform.sandbox import is_path_writable_in_sandbox
...
def format_file_diff(
    ...
    from johnston_core.infrastructure.runtime.git_utils import make_git_diff
