...
from johnston_core.domain.ports.tool_registry import set_default_tool_registry
...
from johnston_core.tools.base import BaseTool, _resolve_app
...
from johnston_core.tools.search import SearchTool
...
async def check_and_confirm_permission(
    ...
    """
    from johnston_core.domain.policies.permission_policy import PermissionAction
    from johnston_core.permission_manager import PermissionManager
    from johnston_core.tools.base import confirm_permission, resolve_subagent_identity
...
async def execute_tool(name: str, args: dict | None, app: Any = None, context: Any = None) -> ToolResult:
    ...
    from johnston_core.tools.base import check_mcp_role_policy
    ...
    try:
        from johnston_core.infrastructure.config.settings import get_settings
        from johnston_core.tools.base import execute_mcp_tool, truncate_output
...
class DefaultToolRegistry:
    ...
    def process_image_file(self, path: str) -> Any:
        from johnston_core.tools.read import process_image_file_sync
