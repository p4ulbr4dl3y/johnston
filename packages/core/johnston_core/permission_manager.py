...
from johnston_core.infrastructure.platform.paths import CONFIG_FILE, LOGS_DIR, SECRETS_FILE
from johnston_core.infrastructure.runtime.git_utils import is_git_repository  # noqa: F401  (re-exported for patching)
from johnston_core.infrastructure.runtime.tool_name import normalize_tool_name
from johnston_core.permission_config import PermissionConfigStore
...
class PermissionManager:
    ...
    def ensure_gitignore(self, project_dir: Optional[str] = None) -> bool:
        ...
        from johnston_core.permission_config import ensure_gitignore as _ensure
