...
from johnston_core.domain.defaults.config import DEFAULT_MAX_TOKENS, ESCALATED_MAX_TOKENS
from johnston_core.infrastructure.adapters.base import (
    build_stream_kwargs,
    new_tool_call_id,
)
from johnston_core.infrastructure.runtime.token_util import (
...
logger = logging.getLogger("johnston_core.base_provider.agent")
...
def _resolve_estimate_tokens(val: Any) -> int:
    import johnston_core.base_provider.agent as agent_mod
...
class StreamLoopMixin:
    ...
    async def _stream_attempts(
        ...
        written list.
        """
        from johnston_core.infrastructure.runtime.circuit_breaker import circuit_breaker
    ...
    async def stream_steps(
        ...
        try:
            while True:
                ...
                from johnston_core.infrastructure.runtime.circuit_breaker import (
