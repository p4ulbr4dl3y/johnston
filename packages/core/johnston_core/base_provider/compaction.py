...
from johnston_core.domain.defaults.prompts import (
    COMPACTION_CREATE_HEADER,
    COMPACTION_SUMMARY_TEMPLATE,
    COMPACTION_UPDATE_HEADER,
)
from johnston_core.domain.policies.messages import is_checkpoint_message, is_system_note
from johnston_core.infrastructure.adapters.base import build_stream_kwargs, normalize_tool_arguments_str
from johnston_core.infrastructure.runtime.token_util import estimate_message_tokens, estimate_tokens
from johnston_core.models_catalog import catalog, get_context_window
...
class CompactionMixin:
    ...
    async def compact_history(self) -> Tuple[bool, str]:
        ...
        try:
            from johnston_core.base_provider.tools import build_prompt_context_async
            ...
            try:
                from johnston_core.adapters import get_adapter
            ...
            from johnston_core.domain.ports.tool_registry import reset_tool_circuit_breakers
