...
def _inject_skills(
    ...
    from johnston_core.application.skills.inject import extract_and_inject_skills
...
def _emit_final_output(
    ...
    if is_stream_json:
        ...
        if not is_quiet:
            ...
            from johnston_core.interfaces.cli.formatter import DIM, RESET, supports_color
