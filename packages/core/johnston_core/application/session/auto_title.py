...
from johnston_core.domain.policies.session_naming import FORK_BASE_MAX_LEN, cap_at_word, fork_marker
...
def _scan_user_text(messages: Any, history: Any) -> str:
    ...
    from johnston_core.domain.policies.messages import is_real_history_user_turn, is_ui_visible_user_message
    ...
    *,
    ...
    if target_agent and getattr(target_agent, "api_type", None) and target_model:
        try:
            ...
            from johnston_core.base_provider.errors import stream_response_with_retry
