...
from johnston_core.infrastructure.runtime.git_utils import run_git_async
from johnston_core.infrastructure.runtime.subagent_tracker import record_subagent_session
from johnston_core.infrastructure.runtime.subagent_worktree import SubagentWorktreeManager
from johnston_core.infrastructure.storage.session_store import get_session_store
...
class SubagentService:
    ...
    async def spawn_subagent(
        ...
        *,
        ...
        from johnston_core.application.session.stream import run_subagent_stream_bg
    ...
    async def send_message(
        ...
        from johnston_core.application.session.stream import send_subagent_followup
