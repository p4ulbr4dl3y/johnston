...
from johnston_core.infrastructure.runtime.frontmatter import parse_csv_list, parse_frontmatter
...
class RoleRegistry:
    ...
    def get_system_prompt_snippet(self, project_dir: Optional[str] = None) -> str:
        with _registry_lock:
            ...
            from johnston_core.infrastructure.runtime.prompt_markdown import format_subagents_markdown
