...
from johnston_core.infrastructure.runtime.fs_signature import compute_dir_signature_hash
...
class SessionStoreCacheMixin:
    ...
    def DISK_CACHE_TTL(self) -> float:
        ...
        mod = sys.modules.get("johnston_core.infrastructure.storage.session_store")
