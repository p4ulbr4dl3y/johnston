...
from johnston_core.infrastructure.platform.platform_utils import atomic_write_json
...
def save_sandbox_config(enabled: bool, config_file: Optional[str] = None) -> None:
    ...
    from johnston_core.infrastructure.config.settings import SandboxSettings, patch_settings
...
def save_theme_config(theme_name: str, config_file: Optional[str] = None) -> None:
    ...
    from johnston_core.infrastructure.config.settings import patch_settings
