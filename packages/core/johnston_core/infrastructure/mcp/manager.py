...
from johnston_core.domain.defaults.config import DEFAULT_MCP_CALL_TIMEOUT
from johnston_core.infrastructure.mcp.call_router import MCPCallRouter
from johnston_core.infrastructure.mcp.client_pool import MCPClientPool
from johnston_core.infrastructure.mcp.config import GLOBAL_MCP_FILE, PROJECT_MCP_FILE
from johnston_core.infrastructure.mcp.config_loader import MCPConfigLoader
from johnston_core.infrastructure.mcp.process_client import MCPProcessClient
from johnston_core.infrastructure.mcp.schema import get_capabilities_for_exposed_tool, get_tool_capabilities
from johnston_core.infrastructure.mcp.tool_catalog import MCPToolCatalog
...
class MCPManager:
    ...
    def _load_config_file(self, path: str, scope: str, servers: Dict[str, Dict[str, Any]]) -> None:
        from johnston_core.infrastructure.mcp.config import load_config_file
    ...
    def _update_server_config(self, name: str, key_updates: Dict[str, Any]) -> Optional[Dict[str, Any]]:
        ...
        from johnston_core.infrastructure.mcp.config import update_server_config
    ...
    def server_enabled(server: Dict[str, Any]) -> bool:
        from johnston_core.infrastructure.mcp.config import server_enabled
    ...
    def add_server(
        ...
        from johnston_core.infrastructure.mcp.config import add_server_config
    ...
    def remove_server(self, name: str, scope: Optional[str] = None) -> bool:
        from johnston_core.infrastructure.mcp.config import remove_server_config
    ...
    def set_server_enabled(self, name: str, enabled: bool, scope: Optional[str] = None) -> bool:
        from johnston_core.infrastructure.mcp.config import set_server_enabled
    ...
    def get_system_prompt_snippet(self) -> str:
        from johnston_core.infrastructure.mcp.schema import format_system_prompt_snippet
    ...
    def _create_client(self, server: Dict[str, Any]) -> Any:
        ...
        env = server.get("env")
        if url:
            from johnston_core.infrastructure.mcp.sse_client import MCPSSEClient
