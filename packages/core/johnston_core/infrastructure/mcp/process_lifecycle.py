...
_default_logger = logging.getLogger("johnston_core.infrastructure.mcp.process_client")
...
class _ProcessClientLoggerProxy:
    ...
    def __getattr__(self, name: str) -> Any:
        mod = sys.modules.get("johnston_core.infrastructure.mcp.process_client")
...
class MCPProcessLifecycleMixin:
    ...
    def _build_popen_kwargs(self) -> Dict[str, Any]:
        ...
        from johnston_core.infrastructure.secrets import interpolate_secrets
