...
from johnston_core.infrastructure.mcp import MCPManager, get_mcp_manager
from johnston_core.infrastructure.platform.paths import CONFIG_DIR
from johnston_tui.presentation.screens.base_modal import BaseModalScreen, status_tag
