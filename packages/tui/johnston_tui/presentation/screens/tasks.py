...
from johnston_tui.presentation.screens.base_selection import HeaderWrapOptionList, ModalSearchNavMixin
...
from johnston_tui.presentation.screens.task_console import (
    TaskConsoleScreen,
    TaskStdinInput,
)
from johnston_tui.presentation.screens.tasks_formatting import (
...
from johnston_tui.utils.responsive import fit_modal_dialog
...
class BaseTasksListScreen(ModalSearchNavMixin, BaseModalScreen[None]):
    ...
    def _update_hint(self) -> None:
        try:
            from johnston_tui.utils.responsive import BREAKPOINT_HINT, resolve_screen_width
