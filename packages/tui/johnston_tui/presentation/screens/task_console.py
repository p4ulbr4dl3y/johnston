...
from johnston_core.infrastructure.tasks.output import process_carriage_returns, strip_ansi
...
from johnston_tui.presentation.screens.constants import MODAL_DIALOG_ID, MODAL_HINT_ID
