...
from johnston_tui.utils.key_aliases import expand_bindings, normalize_key_to_latin
    ...
    def update_step(self, target_highlight: int | None = None) -> None:
        ...
        if self.q_idx < len(self.questions):
            ...
            if self.raw_options:
                ...
                from johnston_tui.utils.responsive import MODAL_CONTENT_GUTTER, MODAL_WIDTH_RATIO, resolve_screen_width
            ...
            from johnston_tui.presentation.tool_renderers import format_ask_user_display
