...
from johnston_tui.presentation.toolcall_header import build_toolcall_header
from johnston_tui.presentation.widgets.chat_markdown import safe_update_markdown
...
class ToolCallContentMixin:
    ...
    def _scroll_if_needed(self, force: bool = False) -> None:
        from johnston_tui.presentation.widgets.chat_messages import scroll_parent_if_needed

        scroll_parent_if_needed(self, force=force)

    def _scroll_to_widget(self, top: bool = False) -> None:
        from johnston_tui.presentation.widgets.chat_messages import scroll_parent_to_widget
    ...
    def _get_target_max_len(self, w: int | None = None) -> tuple[int, bool]:
        ...
        if getattr(self, "_show_hints", False):
            from johnston_tui.presentation.toolcall_header import build_toolcall_hints_list
