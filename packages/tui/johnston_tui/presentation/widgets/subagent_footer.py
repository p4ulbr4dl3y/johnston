...
from johnston_core.infrastructure.runtime.thinking_effort import display_thinking_effort
from johnston_core.models_catalog import catalog, format_context_tokens
...
from johnston_tui.mixins.stream_frame import SPINNER_FRAMES, StreamFrameMixin
from johnston_tui.presentation.widgets.footer_layout import (
    _build_subagent_grid,
    format_hint,
    get_theme_colors,
)
from johnston_tui.utils.responsive import BREAKPOINT_COMPACT, is_compact_width, resolve_width
from johnston_tui.utils.row_format import ellipsize
