...
from johnston_core.infrastructure.platform.paths import IMAGE_EXTENSIONS
from johnston_tui.presentation.screens.constants import STATUS_FOOTER
...
async def try_paste_clipboard_image(widget: Any) -> bool:
    ...
    from johnston_core.infrastructure.platform.paths import TEMP_IMAGES_DIR
    from johnston_core.infrastructure.platform.platform_utils import get_clipboard_image_or_file
...
class ChatInputPasteMixin:
    ...
    def PASTE_LINE_THRESHOLD(self) -> int:
        ...
        chat_mod = sys.modules.get("johnston_tui.chat_input")
