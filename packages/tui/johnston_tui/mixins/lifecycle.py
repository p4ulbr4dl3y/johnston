...
from johnston_core.infrastructure.platform.logging_setup import install_asyncio_exception_handler
...
from johnston_tui.presentation.widgets.attachment_bar import AttachmentBar
from johnston_tui.presentation.widgets.chat_container import ChatView
from johnston_tui.presentation.widgets.plan_notch import PlanNotchContainer
...
def _close_tools_sync() -> None:
    ...
    try:
        from johnston_core.tools.registry import aclose_tools
...
class LifecycleMixin:
    ...
    def on_mount(self) -> None:
        ...
        from johnston_tui.app.theme_manager import prewarm_terminal_palette, theme_manager
