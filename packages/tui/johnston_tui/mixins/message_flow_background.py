...
def schedule_session_save(app: Any, session: Any) -> None:
    ...
    """
    from johnston_tui.mixins.session_persistence import _global_session_write_lock
...
def on_background_shell_completed(app: Any, task_id: str, command_str: str, result: str) -> None:
    ...
    try:
        ...
        from johnston_core.tools.base import format_background_notification, truncate_output
