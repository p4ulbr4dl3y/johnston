...
from johnston_core.theme_manager import ThemeManager as CoreThemeManager
...
class ThemeManager(CoreThemeManager):
    ...
    def get_adapted_theme(self, theme_or_name: str | Theme) -> Theme:
        ...
        if not palette["dark"]:
            from johnston_core.domain.defaults.themes import get_theme
...
def prewarm_terminal_palette() -> None:
    ...
    from johnston_core.infrastructure.platform.terminal_theme import query_terminal_palette
