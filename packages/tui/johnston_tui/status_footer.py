...
from johnston_tui.footer_render import (
    render_compact_rows,
    render_wide_rows,
...
from johnston_tui.utils.responsive import is_compact_width, resolve_width
...
class StatusFooter(ResizeDebounceMixin, GitMetricsMixin, StreamFrameMixin, Static):
    ...
    def refresh_footer(self) -> None:
        if not self.app:
            return
        try:
            from johnston_tui.app.status_state import build_status_kwargs
