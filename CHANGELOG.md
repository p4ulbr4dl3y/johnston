...
## [1.0.0](https://github.com/p4ulbr4dl3y/johnston/compare/johnston-v0.31.0...johnston-v1.0.0) (2026-09-16)
...
* **ci:** correct johnston --roles to johnston roles in Verify CLI step ([dba2bce](https://github.com/p4ulbr4dl3y/johnston/commit/dba2bce2e677c1fb67ec2d3245c3094de8a31aff))
...
* **tests:** fix flaky CI tests (tmp cleanup race, subagent polling) ([eb8c7fc](https://github.com/p4ulbr4dl3y/johnston/commit/eb8c7fc4c8aaf925fa50dc698a0fdbef57fe1689))
* **tests:** fix remaining Windows CI failures (mermaid skipif, killpg mock, path assertions, SQLite cleanup) ([f0cc38b](https://github.com/p4ulbr4dl3y/johnston/commit/f0cc38b85c552a406bb97eed55521e24c3710d2c))
* **tests:** fix ruff import ordering in test_mermaid_renderer ([75d22f7](https://github.com/p4ulbr4dl3y/johnston/commit/75d22f723306c8ae83774a4538f75e4efab05670))
* **tests:** replace fixed pauses with poll loop in pagination mount test ([ae720b3](https://github.com/p4ulbr4dl3y/johnston/commit/ae720b32281bb8ec29b6bdcfd779306f87295e69))
* **tests:** resolve 33 Windows CI failures across 16 files ([9945132](https://github.com/p4ulbr4dl3y/johnston/commit/99451322f15aedc83664c082460cdeeaaaf17cf1))
* **tests:** resolve 4 CI failures across sandbox, search, and mcp tests ([1e09236](https://github.com/p4ulbr4dl3y/johnston/commit/1e09236555587fc07fc7c7a04f0e37d81b792c31))
* **tests:** restore cwd before temp dir cleanup to prevent WinError 32 ([a74650f](https://github.com/p4ulbr4dl3y/johnston/commit/a74650ff9e7938d118b56e6db9f13ecea77d5787))
...
* **infrastructure:** add git metrics service in core ([c3a1f1f](https://github.com/p4ulbr4dl3y/johnston/commit/c3a1f1f6557c41e6ec34937d773f237f5bf10951))
* **permission:** add core permission interactor facade ([16fe040](https://github.com/p4ulbr4dl3y/johnston/commit/16fe04009f8781b5990a2964cb2d2c82e3b15bff))
...
* **session:** add session facade service in core ([eb03c60](https://github.com/p4ulbr4dl3y/johnston/commit/eb03c602f8956eb5d9ba01f53bbbd1999c391c9f))
...
* **subagents:** instruct not to duplicate rules and skills in task ([9a50860](https://github.com/p4ulbr4dl3y/johnston/commit/9a5086072068f20cd511c211fc13d246b029a672))
...
* **tui:** complete 100% core decoupling to client stream and DTOs ([08bb273](https://github.com/p4ulbr4dl3y/johnston/commit/08bb27360300cd2437ca260f133742f75525e4db))
* **tui:** decouple screens via JohnstonClient and DTOs ([742df60](https://github.com/p4ulbr4dl3y/johnston/commit/742df602589147e6568538e3f5ee1885f390c239))
...
* **ui:** display diff stats for create and edit tools in header ([faabdb9](https://github.com/p4ulbr4dl3y/johnston/commit/faabdb962382a75407af3dd78349c423d6d1d68b))
...
* **permissions:** close deny-pattern bypasses and config cache staleness ([1d57f7a](https://github.com/p4ulbr4dl3y/johnston/commit/1d57f7a07d6bded6ba91edf6aee077610008b4ee))
...
* **subagent:** auto-register worktree as session workspace root ([cc48a82](https://github.com/p4ulbr4dl3y/johnston/commit/cc48a82d411b46218885083dffbdd0c63d684f97))
...
* **tools:** guard edit against silent deletion on new_string ([ceda284](https://github.com/p4ulbr4dl3y/johnston/commit/ceda284ac05c849a1d0c7307e8eb38536e2c13f0))
...
* **ui:** unify subagent progress badge for update_plan ([f659ba9](https://github.com/p4ulbr4dl3y/johnston/commit/f659ba9999a10a057bfdd09f114acae7e06a6b8e))
* **ui:** use slash format for diff stats and fix bracket escaping ([edb9dab](https://github.com/p4ulbr4dl3y/johnston/commit/edb9dabd02304a7e3bc8f525a02637605ce52cec))
...
* **anthropic:** enable eager input streaming for direct api ([2bcdb7c](https://github.com/p4ulbr4dl3y/johnston/commit/2bcdb7c7a2271d4e87de540701d8161eb3f39842))
...
* **compaction:** preserve active plan checklist across checkpoints ([f9a1119](https://github.com/p4ulbr4dl3y/johnston/commit/f9a1119b3d2d1aef6bd8cb70a2c0c185cf10f36b))
...
* **core:** bump subagent auto-compact token limit to 200k ([c6cc070](https://github.com/p4ulbr4dl3y/johnston/commit/c6cc070ef21463404a57363fb5cd3b8d414b1bb2))
* **core:** record compaction failed/cancelled dividers to session ([b62bf4f](https://github.com/p4ulbr4dl3y/johnston/commit/b62bf4f4ae6505c6f560567e534740917fe3769c))
...
* **prompts:** add codebase navigation snippet and deduplicate rules ([b2666ca](https://github.com/p4ulbr4dl3y/johnston/commit/b2666ca7a7b57e1029b96431b0c0966aa847f42f))
* **prompts:** emphasize update_plan freshness for compaction recovery ([84791fa](https://github.com/p4ulbr4dl3y/johnston/commit/84791fa510299d9bc60ff6dd6ed287aeda8672b6))
* **read:** add pagination and metadata to dir/archive listing ([13451a7](https://github.com/p4ulbr4dl3y/johnston/commit/13451a74afbb972381ba8a0ee3fbb4d0f8039ca0))
...
* **read:** support reading inner files and folders from archives ([8888da2](https://github.com/p4ulbr4dl3y/johnston/commit/8888da24bc93c2a025c5aa7d4d4e69e5222ef5a3))
* **read:** support zip containers like whl, jar, war and apk ([460fa49](https://github.com/p4ulbr4dl3y/johnston/commit/460fa49329ab47294e5f37660aba96970e9fb026))
...
* **search:** add LRU cache, generator walk, progress callbacks, git check-ignore ([a7c2d7c](https://github.com/p4ulbr4dl3y/johnston/commit/a7c2d7c18b443ea6cb091cc7120b927cfeed20b7))
* **search:** add tree-sitter integration for perfect AST parsing ([c796a72](https://github.com/p4ulbr4dl3y/johnston/commit/c796a72b86da2ce5d39c03065580e97d1c0a6ccd))
* **search:** massive overhaul — parallel processing, gitignore, 30+ languages, before/after context ([d6a3fe2](https://github.com/p4ulbr4dl3y/johnston/commit/d6a3fe20209343ae81073e9789222ea68782080a))
...
* **session:** add input sanitization, fallback write and save alerts ([d7eac3f](https://github.com/p4ulbr4dl3y/johnston/commit/d7eac3fc05147d61466801c3957e0d0da5ab7fcb))
...
* **session:** reconcile missing compaction divider on session load ([ce1960e](https://github.com/p4ulbr4dl3y/johnston/commit/ce1960e772ede67efe0a946600956f39e2add00c))
* **shell:** add background idle timeout, watcher and anti-poll rules ([c4c0755](https://github.com/p4ulbr4dl3y/johnston/commit/c4c075554f45064ecaf666e36295e99b8134e21e))
* **shell:** add cwd parameter and normalize cd commands ([03bed99](https://github.com/p4ulbr4dl3y/johnston/commit/03bed99dfd361a79d32a51b421f6001ceccbb58c))
* **shell:** replace background with wait_seconds ([b507387](https://github.com/p4ulbr4dl3y/johnston/commit/b50738775e5c8a23aa8181a9082cbd350ed5e2d4))
...
* **storage:** index session metadata in sqlite for fast listing ([287243d](https://github.com/p4ulbr4dl3y/johnston/commit/287243d308a97184e2cb8267b5319626b20d9745))
* **stream:** stream tool call generation with status indicators ([c3e3752](https://github.com/p4ulbr4dl3y/johnston/commit/c3e37520ca97a381a4cc86c5c71495fadeca3e65))
...
* **subagents:** stream live shell output and accumulate thoughts ([eb148b8](https://github.com/p4ulbr4dl3y/johnston/commit/eb148b86028be33d0bb537dd398b750e53089ee3))
* **subagents:** stream tool generating state to session listeners ([b6330fd](https://github.com/p4ulbr4dl3y/johnston/commit/b6330fd4abbce801de69ec1b9549c3246d802b2c))
...
* **themes:** add centralized theme manager and tcss tokens ([eb7b22b](https://github.com/p4ulbr4dl3y/johnston/commit/eb7b22b0b6ad609c16bd1dd769ad5839ed5d9f7d))
* **themes:** add charcoal dark theme matching terminal gray ([3246caf](https://github.com/p4ulbr4dl3y/johnston/commit/3246caf09f7269accd66846f6972af330fb784e3))
* **themes:** add github-dark and github-light themes ([4c73126](https://github.com/p4ulbr4dl3y/johnston/commit/4c7312628cff8a0b9391105b727a3d94d33d6606))
* **themes:** add gruvbox, one-dark, rose-pine, monokai and solarized ([d2d28e5](https://github.com/p4ulbr4dl3y/johnston/commit/d2d28e5c408fd6c5e1d5fd31100873ad742a9fa6))
* **themes:** add live preview on highlight and revert on escape ([e469d9e](https://github.com/p4ulbr4dl3y/johnston/commit/e469d9e78ee7982a508e4c99724a67c5866c41c0))
* **themes:** add search filtering with live preview ([e9d0173](https://github.com/p4ulbr4dl3y/johnston/commit/e9d0173271208d66a1145cdf91f07ef4d19730d8))
* **themes:** curate complete suite of 20 modern developer themes ([655a297](https://github.com/p4ulbr4dl3y/johnston/commit/655a2971a838580ecebfbe421c864a57502d642e))
* **themes:** match theme modal to compact effort screen style ([d06a057](https://github.com/p4ulbr4dl3y/johnston/commit/d06a0573db4891e0046bc6a133e60220d2299775))
...
* **themes:** persist active theme in config.json ([aa956fb](https://github.com/p4ulbr4dl3y/johnston/commit/aa956fbe2275c3cbeac10c397d393a64bbb2923c))
* **themes:** set dracula as default theme ([59c32d0](https://github.com/p4ulbr4dl3y/johnston/commit/59c32d0218682b9127ed64ec20a7076a292352ff))
...
* **tools:** add unified codebase search tool ([9d39574](https://github.com/p4ulbr4dl3y/johnston/commit/9d39574a8e00ba6c97e34ed6e53f63db5403bbf7))
...
* **tools:** auto-isolate subagents and drop branch param ([064ae68](https://github.com/p4ulbr4dl3y/johnston/commit/064ae68c2f024a6f092b95c939f6efb6d5ca281b))
* **tools:** forbid shell piping to tail/head in prompts and schema ([4b819fe](https://github.com/p4ulbr4dl3y/johnston/commit/4b819fe6670d3395a409d71c83f93a78250790aa))
...
* **tools:** unify search format and raise shell idle timeout to 60s ([ee01ed5](https://github.com/p4ulbr4dl3y/johnston/commit/ee01ed56645b90bc91eec78fde09b257d81ef9af))
...
* **ui:** add search tool display, progress badge, and expansion ([406edad](https://github.com/p4ulbr4dl3y/johnston/commit/406edad843d483aae2436f1d8dba9ad7d65189e5))
...
* **ui:** debounce ctrl+o and ctrl+b hints to prevent flicker ([fc61406](https://github.com/p4ulbr4dl3y/johnston/commit/fc614063e0de3730e8077ced99591c5d5eda00f4))
...
* **ui:** smooth adaptive tool call argument streaming ([5c39f64](https://github.com/p4ulbr4dl3y/johnston/commit/5c39f64d87b30f272ba70e308f286ea15a3110e2))
* **ui:** smooth relay and lingering fade for toolcall hotkey hints ([4f92e21](https://github.com/p4ulbr4dl3y/johnston/commit/4f92e2118b494cdb057dd7dce3a110c7ffda7b1c))
...
* **app:** cancel workers and skip auto-title on exit to prevent hang ([2c2febe](https://github.com/p4ulbr4dl3y/johnston/commit/2c2febede8c60eb2be58ca6bc2e90c0030c8cbc1))
...
* **commands:** make /compact cancellable via Esc, /new and session switches ([ae23e19](https://github.com/p4ulbr4dl3y/johnston/commit/ae23e197ee0aa3e24e9edd196ea436c512434948))
...
* **commands:** unify worker teardown wait timeout at 2.0s ([8938c3b](https://github.com/p4ulbr4dl3y/johnston/commit/8938c3b20610bed80f13f797b1f4013a09664c78))
* **commands:** wait worker teardown on resume/fork and cancel old-session subagents ([d198526](https://github.com/p4ulbr4dl3y/johnston/commit/d198526aa292244a1959a435c974d21ee4ccf012))
* **compaction:** handle none content when deduping preserved messages ([a2727ec](https://github.com/p4ulbr4dl3y/johnston/commit/a2727ec257d1a1bace0be7f13a37a3caa404f9af))
* **compaction:** queue /compact during generation and unify dividers ([c404c38](https://github.com/p4ulbr4dl3y/johnston/commit/c404c385b4c8bb486f1c59dab52a908ca121d558))
...
* **core:** resolve agent loop wire format and adapter role mismatches ([6835274](https://github.com/p4ulbr4dl3y/johnston/commit/68352748454ebbc8136eba5c4277cf555557cb59))
...
* **mcp:** export CONFIG_DIR and GLOBAL_MCP_FILE in __all__ ([b9df04a](https://github.com/p4ulbr4dl3y/johnston/commit/b9df04a86359da76561095e7aa33f96e6d3e3cba))
* **openai:** clear historical reasoning_content in outbound messages ([8aa2e96](https://github.com/p4ulbr4dl3y/johnston/commit/8aa2e967f9af4fad9a1fa69b725fa83ddac2d76d))
...
* **platform:** use mtime_ns and size for cached json read ([3f15cee](https://github.com/p4ulbr4dl3y/johnston/commit/3f15ceeb13386720927cd457578fd97dcc7e2a3c))
...
* **prompts:** clarify notification status handling and live process alert ([bbf53ca](https://github.com/p4ulbr4dl3y/johnston/commit/bbf53cab8290e98cb8e88128c0f8d3885d70bd5d))
* **prompts:** clean tool schemas and clarify truncation rules ([64978a3](https://github.com/p4ulbr4dl3y/johnston/commit/64978a381b3805023cb4f5a55929eb662f7b6d83))
* **prompts:** correct wire format conventions in tool_io_reference ([fd5473e](https://github.com/p4ulbr4dl3y/johnston/commit/fd5473e0c8f609e65702865483d08c70088a7ed7))
...
* **prompts:** omit raw system_note tag from subagent prompt ([83334ec](https://github.com/p4ulbr4dl3y/johnston/commit/83334eca16c749958670d14172af7523a8493073))
...
* **read:** avoid pagination hint footer to prevent blind file reading ([f9ef2f4](https://github.com/p4ulbr4dl3y/johnston/commit/f9ef2f49681447d1133cf0b8cefbe910117c909b))
...
* **roles:** resolve prompt duplication, scope aliases, and tool guards ([a8b4918](https://github.com/p4ulbr4dl3y/johnston/commit/a8b4918110f611b5f91dc82e8329706948bdca70))
...
* **search:** address reviewer issues on concurrency, parsing, and bounds ([7996f37](https://github.com/p4ulbr4dl3y/johnston/commit/7996f37d517571ccffefa03ddd7b5cc22c361dc9))
* **search:** fix outline regex empty match and normalize paths ([73b63f0](https://github.com/p4ulbr4dl3y/johnston/commit/73b63f0d5fe175771ffa093c4675b1fd1dbd9f75))
* **search:** fix rg stop delimiter, rust generics, and context override ([817ff0b](https://github.com/p4ulbr4dl3y/johnston/commit/817ff0b1c87da2c7919e170647d7393a8a00ad45))
* **search:** optimize outline traversal and treesitter parsing ([3302be7](https://github.com/p4ulbr4dl3y/johnston/commit/3302be79c1ddc4f8572402650b57efdb866174a4))
* **search:** resolve context leak, max_results cap, and parser bugs ([0012d8a](https://github.com/p4ulbr4dl3y/johnston/commit/0012d8a1ab9f59703d149f4c59caff9ca32e1bdd))
...
* **session:** cancel subagents when parent generation is interrupted ([d85d6a7](https://github.com/p4ulbr4dl3y/johnston/commit/d85d6a7ff426c55688db6fe5aaed7d23e34c003e))
...
* **session:** ensure session serializability with default=str on error ([432d863](https://github.com/p4ulbr4dl3y/johnston/commit/432d863ecf7808eb09ed02b929b4e94dfb6fdcc4))
...
* **session:** handle resume conflict cancel and interactive cli picker ([461c0ed](https://github.com/p4ulbr4dl3y/johnston/commit/461c0ed8246603cde4e8017b5500d92b2ffcee0c))
* **session:** persist event divider to disk on compact command success ([ad998a0](https://github.com/p4ulbr4dl3y/johnston/commit/ad998a02780344fbf2339f88d69a727cfc3351ab))
* **session:** run compaction divider reconciliation only on file load ([b6bfbe0](https://github.com/p4ulbr4dl3y/johnston/commit/b6bfbe0194b37f45fb266443c24db816c3dc5736))
* **session:** single-writer terminal save on subagent kill and cancel ([eefe76e](https://github.com/p4ulbr4dl3y/johnston/commit/eefe76ee39171943256d8da513b53cefcc313112))
...
* **shell:** resolve background notifications, timeouts and routing ([c974df6](https://github.com/p4ulbr4dl3y/johnston/commit/c974df605ac95ed3ae6a4eb2ac21897d87451aa6))
...
* **storage:** use insert or replace in bulk_reindex to avoid collision failure ([440370c](https://github.com/p4ulbr4dl3y/johnston/commit/440370c11a352f2f8f88ffdde0b581b2f6029535))
* **stream:** ignore empty thoughts and clean up empty widgets ([ac24606](https://github.com/p4ulbr4dl3y/johnston/commit/ac24606f1780cff4cf7584a807b56f0a73b76e23))
...
* **stream:** restore subagent error notifications to active chat ([0bac932](https://github.com/p4ulbr4dl3y/johnston/commit/0bac9323296f1c374af58a2376dccc50f32d5ef5))
* **stream:** suppress cancelled-subagent chat re-entry and shield teardown ([70c19f9](https://github.com/p4ulbr4dl3y/johnston/commit/70c19f9ce6c66f447dfc464a3fa96544216f45c2))
...
* **themes:** enable dynamic TCSS variable compilation ([e7a371e](https://github.com/p4ulbr4dl3y/johnston/commit/e7a371ece34dd077f7d84a58457bec6ec4ff9cc3))
* **themes:** format modal rows with BaseSelectionScreen ([7acb105](https://github.com/p4ulbr4dl3y/johnston/commit/7acb105b0d4b3246089923a601e7f360fcb075b7))
...
* **themes:** resolve review feedback on lint and test isolation ([aee68cf](https://github.com/p4ulbr4dl3y/johnston/commit/aee68cf0766be7f992f3ec7d16c70f04603bb390))
* **themes:** restore zinc as default theme ([81e8bc9](https://github.com/p4ulbr4dl3y/johnston/commit/81e8bc9ec11b6af219ad0a2e8d67c5c650b97d90))
...
* **tools:** address reviewer feedback on search and read tools ([161b3f4](https://github.com/p4ulbr4dl3y/johnston/commit/161b3f423ab67c7ff29f1af9cd5ac51eb53f2882))
...
* **tools:** improve streaming target extraction and header rendering ([5078b15](https://github.com/p4ulbr4dl3y/johnston/commit/5078b154a9ef2e78f808f597d8136d421c9373ee))
...
* **tools:** reset list polling circuit breakers on compaction ([6cef80a](https://github.com/p4ulbr4dl3y/johnston/commit/6cef80a06fc521fbd5a536cd1c4d1f2281d7cd6a))
...
* **ui:** auto-expand running tools and fix sequential tool spacing ([b396e91](https://github.com/p4ulbr4dl3y/johnston/commit/b396e91079ff6a5d8fe21163a1ecd22ffbbbc31f))
...
* **ui:** await worker teardown on /new to keep welcome screen clean ([b148b67](https://github.com/p4ulbr4dl3y/johnston/commit/b148b67264a36b448f18d219d4983366f61d6804))
* **ui:** cancel current-session subagents on escape ([d9a4e2e](https://github.com/p4ulbr4dl3y/johnston/commit/d9a4e2ef7f17c0b07f1d12d4ae64c463aafc1f6e))
...
* **ui:** delay plan notch reveal after loading chat dialogue ([6785b5b](https://github.com/p4ulbr4dl3y/johnston/commit/6785b5bb0425e9dce26cf0c2fc2089ceb33c0fcb))
...
* **ui:** drop late listener events after subagent kill ([4a8242f](https://github.com/p4ulbr4dl3y/johnston/commit/4a8242f7d42ba81173113a857dc1848baee07ee8))
...
* **ui:** eliminate first message artifact during chat pagination ([1c66489](https://github.com/p4ulbr4dl3y/johnston/commit/1c664897ad6a6f27063c561a5ca02fa13844af94))
* **ui:** eliminate first message flash and scroll flicker on load ([8007af7](https://github.com/p4ulbr4dl3y/johnston/commit/8007af7f44c315a8168b52119a270ea82ec1a9b3))
* **ui:** eliminate first message flash during pagination prepend ([affa438](https://github.com/p4ulbr4dl3y/johnston/commit/affa438faf99b28cec65f95a0c8a91df8d2646d0))
...
* **ui:** fix subagent screen plan notch state restore and persistence ([a0ca63f](https://github.com/p4ulbr4dl3y/johnston/commit/a0ca63f1a16a0cd4cf2724d116a0eb94710d5e4c))
...
* **ui:** guard non-expandable hints and clean unmount coordinator refs ([b9576cc](https://github.com/p4ulbr4dl3y/johnston/commit/b9576ccf360462bb596e637cd625529cf6e232d4))
...
* **ui:** import re at module level and update subagent error test ([3cda280](https://github.com/p4ulbr4dl3y/johnston/commit/3cda280668b4b06b951b46948f4b866e1be47db1))
...
* **ui:** isolate subagent footer spinner to bottom role row ([896ed23](https://github.com/p4ulbr4dl3y/johnston/commit/896ed2390aa5fae045fd6c4213d92e4d3ce2746e))
...
* **ui:** null thinking handle after interruption to prevent double finish ([2d46963](https://github.com/p4ulbr4dl3y/johnston/commit/2d46963e68b1c4984f5357addc502ee09732d5e7))
* **ui:** persist expand states on all click events in subagent screen ([1495363](https://github.com/p4ulbr4dl3y/johnston/commit/1495363c6abc1400424797cddf378797ec998c9e))
* **ui:** persist subagent screen plan and expand states on close ([0321d68](https://github.com/p4ulbr4dl3y/johnston/commit/0321d686cf7ebb14f93adcdabddf4530c13a2b1f))
...
* **ui:** preserve subagent plan notch visibility across visits ([0ea37b5](https://github.com/p4ulbr4dl3y/johnston/commit/0ea37b5460d723c70e9d6b93365234dd01a941b5))
* **ui:** preserve subagent session id and clickability on error ([eb6a714](https://github.com/p4ulbr4dl3y/johnston/commit/eb6a7142d66c4d3b5b54fe3f8b500ccd67782357))
* **ui:** prevent background flickering during subagent chat scroll ([e90800b](https://github.com/p4ulbr4dl3y/johnston/commit/e90800bfc1effee24218000a77f83a86f87341cf))
...
* **ui:** prevent double escaping and propagate path truncation ([512cb30](https://github.com/p4ulbr4dl3y/johnston/commit/512cb30f7e98e296b1be0d44652fb3215a06285a))
* **ui:** prevent negative scroll offset on session restore ([fdfe214](https://github.com/p4ulbr4dl3y/johnston/commit/fdfe214a46fa822b983b3dc7441d5f3b514375bf))
...
* **ui:** reorder subagent hints and drop synthetic thinking notice ([86b6be1](https://github.com/p4ulbr4dl3y/johnston/commit/86b6be16c7c4458011f1f83308b468c246c9e488))
...
* **ui:** resolve tool header review edge cases and escaping ([8c6d1f8](https://github.com/p4ulbr4dl3y/johnston/commit/8c6d1f8c0eb5a9b7bbd212a1e127e81259ec2694))
...
* **ui:** seamless pagination scroll anchoring without blank screen ([ecbe1e6](https://github.com/p4ulbr4dl3y/johnston/commit/ecbe1e6e8599b9db35f533d9f3662716eb88db43))
...
* **ui:** use circle spinner frames and robust timer logic ([c695471](https://github.com/p4ulbr4dl3y/johnston/commit/c695471c36a421c2fe18d26cd88dfbabb3aff02a))
...
* **worktree:** restore worktree on follow-up when branch missing ([b6cc512](https://github.com/p4ulbr4dl3y/johnston/commit/b6cc51226d5b082f036d5aa5039047dc401b6da9))


### Performance Improvements

* **core:** optimize file index, skills parsing and session sqlite index ([4a40ba1](https://github.com/p4ulbr4dl3y/johnston/commit/4a40ba1d977dcf3c47f5bec6748728cb753e019e))
...
* **search:** format outline symbols with line number prefix ([f823d75](https://github.com/p4ulbr4dl3y/johnston/commit/f823d75aabc3a19085adb70d7533b2d7a9bd9a24))
* **search:** omit duplicate matches count in filename mode header ([f8db296](https://github.com/p4ulbr4dl3y/johnston/commit/f8db296bb3186e0d9fb60995dbe5a7ef359efa10))
* **search:** trim header by removing elapsed_ms, query echo and path ([b2fa924](https://github.com/p4ulbr4dl3y/johnston/commit/b2fa9249d6488585a86a4d836fba7d572b8beea6))
* **tools:** optimize read and search output formats for tokens ([6cc9706](https://github.com/p4ulbr4dl3y/johnston/commit/6cc97065480b89db271516c76cd8b59ec9c4060b))
...
* **prompts:** guide agent and subagent to search tool ([ada55e5](https://github.com/p4ulbr4dl3y/johnston/commit/ada55e5e268c681efb42e5a6b136656be94c214c))
* **read:** document archive formats and inner path support in schema ([d455ca0](https://github.com/p4ulbr4dl3y/johnston/commit/d455ca0048c46332f97c56b05af04ac2ef459141))
