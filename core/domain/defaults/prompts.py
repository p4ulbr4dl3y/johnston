...
## Core Rules
1. Research First: Locate files via targeted grep/glob, read exact ranges before making conclusions. Never guess paths, APIs, or signatures.
...
5. Structured Reporting: Conclude with a direct summary:
