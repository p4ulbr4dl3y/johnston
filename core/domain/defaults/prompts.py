...
2. Paths: ALWAYS use relative paths (e.g., `core/foo.py`) for all tool calls. NEVER construct `/worktrees/...` or absolute parent repo paths. NEVER modify files in parent repository paths.
